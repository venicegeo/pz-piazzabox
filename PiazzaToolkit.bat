@ECHO OFF
:MAIN_PAGE
title VeniceGeo Toolkit / Ver: 1.0 / Auth: Sonny.Saniev
...
if %Var1%==4 (
	start cmd /C "title PZ-GATEWAY & color 0F & echo. & cd %PIAZZA% & echo Starting pz-gateway... & cd pz-gateway & java -jar target/piazza-gateway-0.1.0.jar --access.prefix=localhost --jobmanager.prefix=localhost --servicecontroller.port=8088 --servicecontroller.prefix=localhost --servicecontroller.protocol=http & pause"
...
if %Var1%==0 (
	start cmd /C "color 0F & echo. & echo UNDER CONSTRUCTION... & echo. & pause"
)

if %Var1%==help (
	start cmd /C "title Piazza Help & color 0F & echo Following must be installed on the system: & echo ========================================== & echo. & echo Vagrant: https://www.vagrantup.com/ & echo Oracle VM VirtualBox: https://www.virtualbox.org/  & echo Maven 3.3.x: https://maven.apache.org/ & echo. & pause"
)
