...
if %Var1%==4 (
	start cmd /C "title PZ-GATEWAY & echo. & cd %LOCAL_PIAZZA_REPO_PATH% & echo Starting pz-gateway... & cd pz-gateway & java -jar target/piazza-gateway-1.0.0.jar --access.prefix=localhost --search.url=http://localhost:8581 --jobmanager.prefix=localhost --servicecontroller.port=8088 --servicecontroller.prefix=localhost --servicecontroller.protocol=http --logger.url=http://192.168.46.46:14600 --uuid.url=http://192.168.48.48:14800 --workflow.url=http://192.168.50.50:14400 --ingest.url=http://localhost:8084 --access.url=http://localhost:8085 & pause"
	start cmd /C "title PZ-INGEST & echo. & cd %LOCAL_PIAZZA_REPO_PATH% & echo Starting pz-ingest... & cd pz-ingest & java -jar target/piazza-ingest-1.0.0.jar --search.url=http://localhost:8580 --logger.url=http://192.168.46.46:14600 --uuid.url=http://192.168.48.48:14800 --workflow.url=http://192.168.50.50:14400 --access.url=http://localhost:8085 & pause"
 	start cmd /C "title PZ-ACCESS & echo. & cd %LOCAL_PIAZZA_REPO_PATH% & echo Starting pz-access... & cd pz-access & java -jar target/piazza-access-1.0.0.jar --logger.url=http://192.168.46.46:14600 --uuid.url=http://192.168.48.48:14800 & pause"
 	start cmd /C "title PZ-JOBMANAGER & echo. & cd %LOCAL_PIAZZA_REPO_PATH% & echo Starting pz-jobmanager... & cd pz-jobmanager & java -jar target/piazza-jobmanager-1.0.0.jar --logger.url=http://192.168.46.46:14600 --uuid.url=http://192.168.48.48:14800 & pause"
